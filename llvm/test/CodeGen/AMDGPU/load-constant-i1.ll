...
; GFX1250-REAL16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_3) | instid1(SALU_CYCLE_1)
; GFX1250-REAL16-NEXT:    v_mov_b32_e32 v0, s4
...
; GFX1250-NEXT:    s_bfe_i32 s2, s2, 0x10001
; GFX1250-NEXT:    v_dual_mov_b32 v2, s3 :: v_dual_mov_b32 v1, s2
...
; GFX1250-NEXT:    s_bfe_i32 s2, s2, 0x10001
; GFX1250-NEXT:    v_dual_mov_b32 v2, s4 :: v_dual_mov_b32 v1, s2
...
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v7, s3
...
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-NEXT:    v_dual_mov_b32 v2, s8 :: v_dual_mov_b32 v1, s2
...
; GFX12-NEXT:    v_dual_mov_b32 v1, s8 :: v_dual_mov_b32 v6, s10
; GFX12-NEXT:    v_dual_mov_b32 v11, s6 :: v_dual_mov_b32 v12, s9
; GFX12-NEXT:    v_mov_b32_e32 v13, s5
...
; GFX1250-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v15, s3
; GFX1250-NEXT:    v_dual_mov_b32 v2, s6 :: v_dual_mov_b32 v14, s14
...
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-NEXT:    v_dual_mov_b32 v2, s16 :: v_dual_mov_b32 v1, s2
...
; GFX12-NEXT:    v_dual_mov_b32 v12, s23 :: v_dual_mov_b32 v15, s7
; GFX12-NEXT:    v_dual_mov_b32 v14, s22 :: v_dual_mov_b32 v17, s6
; GFX12-NEXT:    v_dual_mov_b32 v16, s21 :: v_dual_mov_b32 v19, s5
; GFX12-NEXT:    v_dual_mov_b32 v18, s20 :: v_dual_mov_b32 v21, s4
; GFX12-NEXT:    v_dual_mov_b32 v20, s18 :: v_dual_mov_b32 v23, s3
; GFX12-NEXT:    s_bfe_u32 s2, s2, 0x1001e
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_dual_mov_b32 v5, s15 :: v_dual_mov_b32 v2, s2
...
; GFX12-NEXT:    v_dual_mov_b32 v13, s8 :: v_dual_mov_b32 v22, s19
...
; GFX1250-NEXT:    v_dual_mov_b32 v13, s8 :: v_dual_mov_b32 v14, s22
; GFX1250-NEXT:    v_dual_mov_b32 v15, s7 :: v_dual_mov_b32 v16, s21
; GFX1250-NEXT:    v_dual_mov_b32 v17, s6 :: v_dual_mov_b32 v18, s20
; GFX1250-NEXT:    v_dual_mov_b32 v19, s5 :: v_dual_mov_b32 v20, s18
; GFX1250-NEXT:    v_dual_mov_b32 v21, s4 :: v_dual_mov_b32 v22, s19
...
; GFX1250-NEXT:    v_dual_mov_b32 v12, s23 :: v_dual_mov_b32 v23, s3
...
; GFX12-NEXT:    v_dual_mov_b32 v12, s14 :: v_dual_mov_b32 v15, s11
; GFX12-NEXT:    v_dual_mov_b32 v14, s12 :: v_dual_mov_b32 v17, s9
; GFX12-NEXT:    v_dual_mov_b32 v16, s10 :: v_dual_mov_b32 v19, s7
; GFX12-NEXT:    v_dual_mov_b32 v18, s8 :: v_dual_mov_b32 v21, s5
...
; GFX12-NEXT:    v_dual_mov_b32 v13, s13 :: v_dual_mov_b32 v22, s4
; GFX12-NEXT:    s_clause 0x5
; GFX12-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:80
; GFX12-NEXT:    global_store_b128 v24, v[0:3], s[0:1] offset:64
; GFX12-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:48
...
; GFX1250-NEXT:    v_dual_mov_b32 v13, s13 :: v_dual_mov_b32 v14, s12
; GFX1250-NEXT:    v_dual_mov_b32 v15, s11 :: v_dual_mov_b32 v16, s10
; GFX1250-NEXT:    v_dual_mov_b32 v17, s9 :: v_dual_mov_b32 v18, s8
; GFX1250-NEXT:    v_dual_mov_b32 v19, s7 :: v_dual_mov_b32 v20, s6
; GFX1250-NEXT:    v_dual_mov_b32 v21, s5 :: v_dual_mov_b32 v22, s4
; GFX1250-NEXT:    s_bfe_i32 s2, s2, 0x1001d
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-NEXT:    v_dual_mov_b32 v2, s33 :: v_dual_mov_b32 v1, s2
...
; GFX1250-NEXT:    v_dual_mov_b32 v12, s14 :: v_dual_mov_b32 v23, s3
; GFX1250-NEXT:    s_clause 0x5
; GFX1250-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:80
; GFX1250-NEXT:    global_store_b128 v24, v[0:3], s[0:1] offset:64
; GFX1250-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:48
...
; GFX12-NEXT:    v_mov_b32_e32 v1, s26
...
; GFX12-NEXT:    v_dual_mov_b32 v2, s57 :: v_dual_mov_b32 v5, s24
; GFX12-NEXT:    v_dual_mov_b32 v4, s56 :: v_dual_mov_b32 v7, s23
; GFX12-NEXT:    v_dual_mov_b32 v6, s55 :: v_dual_mov_b32 v9, s22
; GFX12-NEXT:    s_bfe_u32 s4, s2, 0x10003
; GFX12-NEXT:    s_bfe_u32 s5, s2, 0x10001
; GFX12-NEXT:    s_bfe_u32 s6, s2, 0x10007
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_dual_mov_b32 v19, s17 :: v_dual_mov_b32 v16, s2
...
; GFX12-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:208
; GFX12-NEXT:    global_store_b128 v24, v[12:15], s[0:1] offset:192
; GFX12-NEXT:    v_mov_b32_e32 v1, s50
...
; GFX12-NEXT:    v_dual_mov_b32 v2, s49 :: v_dual_mov_b32 v5, s46
; GFX12-NEXT:    v_dual_mov_b32 v4, s47 :: v_dual_mov_b32 v7, s44
; GFX12-NEXT:    v_dual_mov_b32 v6, s45 :: v_dual_mov_b32 v9, s42
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_dual_mov_b32 v19, s33 :: v_dual_mov_b32 v16, s2
...
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX12-NEXT:    v_dual_mov_b32 v3, v5 :: v_dual_and_b32 v0, 0xffff, v0
...
; GFX1250-REAL16-NEXT:    v_readfirstlane_b32 s2, v0
; GFX1250-REAL16-NEXT:    s_and_b32 s3, 0xffff, s2
; GFX1250-REAL16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1250-REAL16-NEXT:    s_lshr_b32 s3, s3, 2
; GFX1250-REAL16-NEXT:    s_and_b32 s3, 0xffff, s3
; GFX1250-REAL16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v3, v1
; GFX1250-REAL16-NEXT:    global_store_b128 v1, v[0:3], s[0:1]
; GFX1250-REAL16-NEXT:    s_endpgm
  %load = load <3 x i1>, ptr addrspace(4) %in
...
; GFX1250-NEXT:    v_dual_mov_b32 v5, v1 :: v_dual_mov_b32 v7, v1
...
; GFX12-NEXT:    v_mov_b32_e32 v9, s11
...
; GFX1250-NEXT:    v_dual_mov_b32 v10, s12 :: v_dual_ashrrev_i32 v13, 31, v12
...
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v9, v1 :: v_dual_mov_b32 v11, v1
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v13, v1 :: v_dual_mov_b32 v15, v1
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v17, v1 :: v_dual_mov_b32 v19, v1
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v21, v1 :: v_dual_mov_b32 v23, v1
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v25, v1 :: v_dual_mov_b32 v27, v1
; GFX1250-FAKE16-NEXT:    v_mov_b32_e32 v29, v1
...
; GFX12-NEXT:    v_dual_mov_b32 v5, s7 :: v_dual_mov_b32 v2, s4
...
; GFX12-NEXT:    v_dual_mov_b32 v5, s80 :: v_dual_mov_b32 v6, s81
; GFX12-NEXT:    v_dual_mov_b32 v7, s82 :: v_dual_mov_b32 v8, s83
; GFX12-NEXT:    v_dual_mov_b32 v9, s84 :: v_dual_mov_b32 v10, s85
; GFX12-NEXT:    v_dual_mov_b32 v11, s86 :: v_dual_mov_b32 v12, s87
; GFX12-NEXT:    v_mov_b32_e32 v13, s90
...
; GFX12-NEXT:    v_mov_b32_e32 v3, s74
; GFX12-NEXT:    s_bfe_i64 s[66:67], s[66:67], 0x10000
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_dual_mov_b32 v4, s75 :: v_dual_mov_b32 v5, s66
...
; GFX1250-NEXT:    s_wait_xcnt 0x4
; GFX1250-NEXT:    v_dual_mov_b32 v4, s80 :: v_dual_mov_b32 v5, s81
; GFX1250-NEXT:    v_dual_mov_b32 v6, s82 :: v_dual_mov_b32 v7, s83
; GFX1250-NEXT:    s_wait_xcnt 0x3
; GFX1250-NEXT:    v_dual_mov_b32 v10, s84 :: v_dual_mov_b32 v11, s85
; GFX1250-NEXT:    v_dual_mov_b32 v12, s86 :: v_dual_mov_b32 v13, s87
; GFX1250-NEXT:    s_wait_xcnt 0x2
; GFX1250-NEXT:    v_mov_b32_e32 v14, s90
...
; GFX1250-NEXT:    v_mov_b32_e32 v2, s74
; GFX1250-NEXT:    s_bfe_i64 s[66:67], s[66:67], 0x10000
; GFX1250-NEXT:    s_wait_xcnt 0x4
; GFX1250-NEXT:    v_dual_mov_b32 v3, s75 :: v_dual_mov_b32 v4, s66
