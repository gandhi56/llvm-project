...
; SI-NEXT:    v_cmp_nle_f32_e64 s[0:1], s0, v0
...
; SI-NEXT:    v_rcp_f32_e32 v3, v1
; SI-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 4, 2), 3
; SI-NEXT:    v_fma_f32 v5, -v1, v3, 1.0
; SI-NEXT:    v_fma_f32 v3, v5, v3, v3
; SI-NEXT:    v_mul_f32_e32 v5, v0, v3
; SI-NEXT:    v_fma_f32 v6, -v1, v5, v0
; SI-NEXT:    v_fma_f32 v5, v6, v3, v5
; SI-NEXT:    v_fma_f32 v0, -v1, v5, v0
; SI-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 4, 2), 0
; SI-NEXT:    v_div_fmas_f32 v0, v0, v3, v5
; SI-NEXT:    v_div_fixup_f32 v0, v0, v4, v2
...
; SI-NEXT:    v_cmp_nge_f64_e64 s[2:3], |s[2:3]|, v[2:3]
; SI-NEXT:    s_and_b64 vcc, s[2:3], s[0:1]
; SI-NEXT:    v_mov_b32_e32 v2, 0x7ff80000
; SI-NEXT:    v_cndmask_b32_e32 v1, v2, v1, vcc
...
; SI-NEXT:    s_mov_b64 vcc, exec
; SI-NEXT:    s_cbranch_execz .LBB10_14
; SI-NEXT:  ; %bb.12:
...
; SI-NEXT:    s_mov_b64 vcc, exec
; SI-NEXT:    s_cbranch_execz .LBB10_23
; SI-NEXT:  ; %bb.21:
...
; SI-NEXT:    s_mov_b64 vcc, exec
; SI-NEXT:    s_cbranch_execz .LBB10_32
; SI-NEXT:  ; %bb.30:
...
; SI-NEXT:    v_rndne_f32_e32 v8, v8
; SI-NEXT:    v_fma_f32 v8, -v8, v7, v10
...
; CI-NEXT:    s_cbranch_execz .LBB10_4
; CI-NEXT:  ; %bb.2:
...
; CI-NEXT:    s_cbranch_execz .LBB10_14
; CI-NEXT:  ; %bb.12:
...
; CI-NEXT:    s_cbranch_execz .LBB10_23
; CI-NEXT:  ; %bb.21:
...
; CI-NEXT:    s_cbranch_execz .LBB10_32
; CI-NEXT:  ; %bb.30:
...
; GFX1200-NEXT:    s_cbranch_execz .LBB11_4
; GFX1200-NEXT:  ; %bb.2:
...
; GFX1200-NEXT:    s_cbranch_execz .LBB11_13
; GFX1200-NEXT:  ; %bb.11:
; GFX1200-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX1200-NEXT:    s_cbranch_execz .LBB12_4
; GFX1200-NEXT:  ; %bb.2:
...
; GFX1200-NEXT:    s_cbranch_execz .LBB12_13
; GFX1200-NEXT:  ; %bb.11:
; GFX1200-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX1200-NEXT:    s_cbranch_execz .LBB12_22
; GFX1200-NEXT:  ; %bb.20:
; GFX1200-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX1200-NEXT:    s_cbranch_execz .LBB12_31
; GFX1200-NEXT:  ; %bb.29:
; GFX1200-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; SI-NEXT:    s_mov_b64 vcc, exec
; SI-NEXT:    s_cbranch_execz .LBB13_4
; SI-NEXT:  ; %bb.2:
; SI-NEXT:    v_mov_b32_e32 v0, s0
; SI-NEXT:    v_mov_b32_e32 v1, s1
...
; SI-NEXT:    s_cselect_b32 s0, 0, s2
; SI-NEXT:    s_mov_b64 vcc, exec
; SI-NEXT:    s_cbranch_execz .LBB13_13
; SI-NEXT:  ; %bb.11:
...
; SI-NEXT:    v_cmp_nge_f64_e64 s[6:7], |s[6:7]|, v[4:5]
; SI-NEXT:    s_and_b64 vcc, s[6:7], s[0:1]
; SI-NEXT:    v_mov_b32_e32 v6, 0x7ff80000
; SI-NEXT:    v_cndmask_b32_e32 v1, v6, v1, vcc
; SI-NEXT:    v_cndmask_b32_e32 v0, 0, v0, vcc
; SI-NEXT:    s_mov_b32 s11, 0xf000
; SI-NEXT:    s_mov_b32 s10, -1
; SI-NEXT:    v_cmp_lg_f64_e64 s[0:1], s[4:5], 0
; SI-NEXT:    v_cmp_nge_f64_e64 s[2:3], |s[2:3]|, v[4:5]
; SI-NEXT:    s_and_b64 vcc, s[2:3], s[0:1]
; SI-NEXT:    v_cndmask_b32_e32 v3, v6, v3, vcc
...
; SI-NEXT:    v_cmp_gt_f64_e32 vcc, 0, v[0:1]
; SI-NEXT:    v_add_f64 v[2:3], v[0:1], 1.0
; SI-NEXT:    v_cndmask_b32_e32 v0, v0, v2, vcc
; SI-NEXT:    v_cndmask_b32_e32 v1, v1, v3, vcc
; SI-NEXT:    v_mov_b32_e32 v2, s3
...
; SI-NEXT:    s_mov_b64 vcc, exec
; SI-NEXT:    s_cbranch_execz .LBB15_13
; SI-NEXT:  ; %bb.11:
; SI-NEXT:    v_mov_b32_e32 v2, s6
...
; SI-NEXT:    v_cmp_gt_f64_e32 vcc, 0, v[2:3]
; SI-NEXT:    v_add_f64 v[4:5], v[2:3], 1.0
; SI-NEXT:    v_cndmask_b32_e32 v2, v2, v4, vcc
; SI-NEXT:    v_cndmask_b32_e32 v3, v3, v5, vcc
...
; SI-NEXT:    s_mov_b32 s3, 0xf000
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    v_cmp_nge_f64_e64 vcc, |s[4:5]|, v[4:5]
; SI-NEXT:    v_cndmask_b32_e32 v3, v6, v3, vcc
; SI-NEXT:    v_cndmask_b32_e32 v2, 0, v2, vcc
; SI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0
; SI-NEXT:    s_endpgm
