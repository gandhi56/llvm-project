...
; GFX7-LABEL: test_unsigned_i1_f32:
; GFX7:       ; %bb.0:
...
; GFX7-LABEL: test_unsigned_i8_f32:
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-NEXT:    v_cvt_u32_f32_e32 v0, v0
...
; GFX7-LABEL: test_unsigned_i16_f32:
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-NEXT:    v_cvt_u32_f32_e32 v0, v0
...
; GFX7-LABEL: test_unsigned_i32_f32:
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX7-NEXT:    s_setpc_b64 s[30:31]
...
; GFX7-LABEL: test_unsigned_i1_f64:
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX7-LABEL: test_unsigned_i8_f64:
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-NEXT:    v_cvt_u32_f64_e32 v0, v[0:1]
; GFX7-NEXT:    v_min_u32_e32 v0, 0xff, v0
...
; GFX7-LABEL: test_unsigned_i16_f64:
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-NEXT:    v_cvt_u32_f64_e32 v0, v[0:1]
; GFX7-NEXT:    v_min_u32_e32 v0, 0xffff, v0
...
; GFX7-LABEL: test_unsigned_i32_f64:
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-NEXT:    v_cvt_u32_f64_e32 v0, v[0:1]
; GFX7-NEXT:    s_setpc_b64 s[30:31]
...
; GFX7-LABEL: test_unsigned_i1_f16:
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX7-LABEL: test_unsigned_i8_f16:
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-NEXT:    v_cvt_f32_f16_e32 v0, v0
; GFX7-NEXT:    v_cvt_u32_f32_e32 v0, v0
...
; GFX7-LABEL: test_unsigned_i16_f16:
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-NEXT:    v_cvt_f32_f16_e32 v0, v0
; GFX7-NEXT:    v_cvt_u32_f32_e32 v0, v0
...
; GFX7-LABEL: test_unsigned_i32_f16:
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-NEXT:    v_cvt_f32_f16_e32 v0, v0
; GFX7-NEXT:    v_cvt_u32_f32_e32 v0, v0
...
; GFX7-LABEL: test_unsigned_i64_f16:
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-NEXT:    v_cvt_f32_f16_e32 v0, v0
