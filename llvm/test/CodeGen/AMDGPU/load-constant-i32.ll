...
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_dual_mov_b32 v8, s12 :: v_dual_mov_b32 v9, s13
...
; GFX1250-NEXT:    s_load_b256 s[0:7], s[10:11], 0x0 nv
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v10, 0 :: v_dual_mov_b32 v0, s4
; GFX1250-NEXT:    v_dual_mov_b32 v1, s5 :: v_dual_mov_b32 v2, s6
; GFX1250-NEXT:    v_dual_mov_b32 v3, s7 :: v_dual_mov_b32 v4, s0
; GFX1250-NEXT:    v_dual_mov_b32 v5, s1 :: v_dual_mov_b32 v6, s2
...
; GFX12-NEXT:    v_dual_mov_b32 v3, s15 :: v_dual_mov_b32 v2, s14
...
; GFX1250-NEXT:    s_load_b256 s[0:7], s[10:11], 0x0 nv
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v12, 0 :: v_dual_mov_b32 v4, s4
...
; GFX1250-NEXT:    v_dual_mov_b32 v27, s20 :: v_dual_mov_b32 v0, s0
; GFX1250-NEXT:    s_ashr_i32 s19, s0, 31
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-NEXT:    v_dual_mov_b32 v2, s1 :: v_dual_mov_b32 v1, s19
...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v0, s30
...
; GFX1250-NEXT:    v_dual_mov_b32 v10, s27 :: v_dual_mov_b32 v9, s61
; GFX1250-NEXT:    s_ashr_i32 s60, s27, 31
; GFX1250-NEXT:    v_dual_mov_b32 v12, s24 :: v_dual_mov_b32 v11, s60
; GFX1250-NEXT:    s_ashr_i32 s59, s24, 31
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-NEXT:    v_dual_mov_b32 v14, s25 :: v_dual_mov_b32 v13, s59
...
; GFX1250-NEXT:    v_dual_mov_b32 v2, s23 :: v_dual_mov_b32 v1, s24
; GFX1250-NEXT:    s_ashr_i32 s57, s23, 31
; GFX1250-NEXT:    s_wait_xcnt 0x2
; GFX1250-NEXT:    v_dual_mov_b32 v4, s20 :: v_dual_mov_b32 v3, s57
; GFX1250-NEXT:    s_ashr_i32 s56, s20, 31
; GFX1250-NEXT:    v_dual_mov_b32 v6, s21 :: v_dual_mov_b32 v5, s56
; GFX1250-NEXT:    s_ashr_i32 s55, s21, 31
; GFX1250-NEXT:    s_wait_xcnt 0x1
; GFX1250-NEXT:    v_dual_mov_b32 v8, s18 :: v_dual_mov_b32 v7, s55
; GFX1250-NEXT:    s_ashr_i32 s54, s18, 31
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_4) | instid1(SALU_CYCLE_1)
; GFX1250-NEXT:    v_dual_mov_b32 v10, s19 :: v_dual_mov_b32 v9, s54
; GFX1250-NEXT:    s_ashr_i32 s53, s19, 31
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v12, s16 :: v_dual_mov_b32 v11, s53
; GFX1250-NEXT:    s_ashr_i32 s52, s16, 31
; GFX1250-NEXT:    v_dual_mov_b32 v14, s17 :: v_dual_mov_b32 v13, s52
; GFX1250-NEXT:    s_ashr_i32 s51, s17, 31
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX1250-NEXT:    v_dual_mov_b32 v16, s14 :: v_dual_mov_b32 v15, s51
; GFX1250-NEXT:    s_ashr_i32 s50, s14, 31
; GFX1250-NEXT:    v_dual_mov_b32 v18, s15 :: v_dual_mov_b32 v17, s50
; GFX1250-NEXT:    s_ashr_i32 s49, s15, 31
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX1250-NEXT:    v_dual_mov_b32 v20, s12 :: v_dual_mov_b32 v19, s49
; GFX1250-NEXT:    s_ashr_i32 s48, s12, 31
; GFX1250-NEXT:    v_dual_mov_b32 v22, s13 :: v_dual_mov_b32 v21, s48
...
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_4) | instid1(SALU_CYCLE_1)
; GFX1250-NEXT:    v_dual_mov_b32 v2, s11 :: v_dual_mov_b32 v1, s46
; GFX1250-NEXT:    s_ashr_i32 s45, s11, 31
; GFX1250-NEXT:    s_wait_xcnt 0x4
; GFX1250-NEXT:    v_dual_mov_b32 v4, s8 :: v_dual_mov_b32 v3, s45
; GFX1250-NEXT:    s_ashr_i32 s44, s8, 31
; GFX1250-NEXT:    v_dual_mov_b32 v6, s9 :: v_dual_mov_b32 v5, s44
; GFX1250-NEXT:    s_ashr_i32 s43, s9, 31
; GFX1250-NEXT:    s_wait_xcnt 0x3
; GFX1250-NEXT:    v_dual_mov_b32 v8, s6 :: v_dual_mov_b32 v7, s43
; GFX1250-NEXT:    s_ashr_i32 s42, s6, 31
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_4) | instid1(SALU_CYCLE_1)
; GFX1250-NEXT:    v_dual_mov_b32 v10, s7 :: v_dual_mov_b32 v9, s42
; GFX1250-NEXT:    s_ashr_i32 s41, s7, 31
; GFX1250-NEXT:    s_wait_xcnt 0x2
; GFX1250-NEXT:    v_dual_mov_b32 v12, s4 :: v_dual_mov_b32 v11, s41
; GFX1250-NEXT:    s_ashr_i32 s40, s4, 31
; GFX1250-NEXT:    v_dual_mov_b32 v14, s5 :: v_dual_mov_b32 v13, s40
; GFX1250-NEXT:    s_ashr_i32 s39, s5, 31
; GFX1250-NEXT:    s_wait_xcnt 0x1
; GFX1250-NEXT:    v_dual_mov_b32 v16, s2 :: v_dual_mov_b32 v15, s39
; GFX1250-NEXT:    s_ashr_i32 s38, s2, 31
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_4) | instid1(SALU_CYCLE_1)
; GFX1250-NEXT:    v_dual_mov_b32 v18, s3 :: v_dual_mov_b32 v17, s38
; GFX1250-NEXT:    s_ashr_i32 s35, s3, 31
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v20, s0 :: v_dual_mov_b32 v19, s35
; GFX1250-NEXT:    s_ashr_i32 s34, s0, 31
; GFX1250-NEXT:    v_dual_mov_b32 v22, s1 :: v_dual_mov_b32 v21, s34
