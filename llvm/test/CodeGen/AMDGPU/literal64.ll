...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1310 < %s | FileCheck --check-prefixes=GFX13,GFX13-SDAG %s
; RUN: llc -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1310 < %s | FileCheck --check-prefixes=GFX13,GFX13-GISEL %s

define amdgpu_ps i64 @s_add_u64(i64 inreg %a) {
; GFX1250-LABEL: s_add_u64:
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-NEXT:    s_add_nc_u64 s[0:1], s[0:1], 0xf12345678
; GFX1250-NEXT:    ; return to shader part epilog
;
; GFX13-LABEL: s_add_u64:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_add_nc_u64 s[0:1], s[0:1], 0xf12345678
...
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-NEXT:    v_add_nc_u64_e32 v[0:1], 0xf12345678, v[0:1]
...
; GFX1250-LABEL: s_add_neg_u64:
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-NEXT:    s_add_nc_u64 s[0:1], s[0:1], 0xfffffff0edcba988
; GFX1250-NEXT:    ; return to shader part epilog
;
; GFX13-LABEL: s_add_neg_u64:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_add_nc_u64 s[0:1], s[0:1], 0xfffffff0edcba988
; GFX13-NEXT:    ; return to shader part epilog
...
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-NEXT:    v_add_nc_u64_e32 v[0:1], 0xfffffff0edcba988, v[0:1]
; GFX1250-NEXT:    global_store_b64 v[2:3], v[0:1], off
; GFX1250-NEXT:    s_endpgm
;
...
; GFX1250-LABEL: s_sub_u64:
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-NEXT:    s_sub_nc_u64 s[0:1], 0xf12345678, s[0:1]
; GFX1250-NEXT:    ; return to shader part epilog
;
; GFX13-LABEL: s_sub_u64:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_sub_nc_u64 s[0:1], 0xf12345678, s[0:1]
; GFX13-NEXT:    ; return to shader part epilog
...
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-NEXT:    v_sub_nc_u64_e32 v[0:1], 0xf12345678, v[0:1]
; GFX1250-NEXT:    global_store_b64 v[2:3], v[0:1], off
; GFX1250-NEXT:    s_endpgm
;
...
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_mov_b64_e32 v[2:3], 0xf12345678
; GFX1250-NEXT:    global_atomic_add_u64 v[0:1], v[2:3], off scope:SCOPE_SYS
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX13-LABEL: v_mov_b64_int:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
; GFX13-NEXT:    s_wait_bvhcnt 0x0
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    v_dual_mov_b32 v2, 0x12345678 :: v_dual_mov_b32 v3, 15
; GFX13-NEXT:    global_atomic_add_u64 v[0:1], v[2:3], off scope:SCOPE_SYS
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX13-NEXT:    s_wait_bvhcnt 0x0
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    v_mov_b32_e32 v2, 0x33333333
; GFX13-NEXT:    v_mov_b32_e32 v3, 0x40632333
...
; GFX13-SDAG-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s0
; GFX13-SDAG-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX13-GISEL-LABEL: class_f64:
; GFX13-GISEL:       ; %bb.0:
...
; GFX13-GISEL-NEXT:    s_mov_b64 s[0:1], 0x4063233333333333
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v1, s1
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v2, s2
; GFX13-GISEL-NEXT:    v_cmp_class_f64_e64 s0, v[0:1], v2
; GFX13-GISEL-NEXT:    s_cmp_lg_u32 s0, 0
; GFX13-GISEL-NEXT:    s_cselect_b32 s0, 1, 0
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v0, s0
...
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_rsq_f64_e32 v[0:1], 0x4063233333333333
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX13-LABEL: rsq_f64:
; GFX13:       ; %bb.0:
...
; GFX13-NEXT:    s_wait_bvhcnt 0x0
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    v_rsq_f64_e32 v[0:1], 0x4063233333333333
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-LABEL: s_and_b64:
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-NEXT:    s_and_b64 s[0:1], s[0:1], 0xf12345678
; GFX1250-NEXT:    ; return to shader part epilog
;
; GFX13-LABEL: s_and_b64:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_and_b64 s[0:1], s[0:1], 0xf12345678
; GFX13-NEXT:    ; return to shader part epilog
...
; GFX1250-NEXT:    ; return to shader part epilog
;
; GFX13-LABEL: v_add_f64_200.1:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_add_f64_e32 v[0:1], 0x4069033333333333, v[0:1]
; GFX13-NEXT:    ; return to shader part epilog
...
; GFX1250-NEXT:    ; return to shader part epilog
;
; GFX13-LABEL: v_add_f64_200.0:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_add_f64_e32 v[0:1], 0x40690000, v[0:1]
; GFX13-NEXT:    ; return to shader part epilog
...
; GFX1250-SDAG:       ; %bb.0:
; GFX1250-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-SDAG-NEXT:    s_mov_b64 s[0:1], 0xf12345678
...
; GFX1250-GISEL:       ; %bb.0:
; GFX1250-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-GISEL-NEXT:    v_mov_b64_e32 v[2:3], 0xf12345678
...
; GFX1250-SDAG:       ; %bb.0:
; GFX1250-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-SDAG-NEXT:    v_fmaak_f64 v[4:5], v[0:1], v[2:3], 0x4063233333333333
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[2:3], 0x4069033333333333
; GFX1250-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-SDAG-NEXT:    v_fmaak_f64 v[0:1], v[0:1], v[4:5], 0x4069033333333333
...
; GFX1250-GISEL:       ; %bb.0:
; GFX1250-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-GISEL-NEXT:    v_mov_b64_e32 v[4:5], 0x4063233333333333
...
; GFX1250-GISEL-NEXT:    v_fmaak_f64 v[0:1], v[0:1], v[4:5], 0x4069033333333333
...
; GFX1250-GISEL-NEXT:    ; return to shader part epilog
;
; GFX13-SDAG-LABEL: v_fma_f64:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    v_fmaak_f64 v[4:5], v[0:1], v[2:3], 0x4063233333333333
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v2, 0x33333333
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v3, 0x40690333
; GFX13-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v4, 0x33333333
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v5, 0x40632333
; GFX13-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
; GFX13-GISEL-NEXT:    v_fmac_f64_e32 v[4:5], v[0:1], v[2:3]
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v2, 0x33333333
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v3, 0x40690333
...
; GFX1250-SDAG-LABEL: v_add_neg_f64:
; GFX1250-SDAG:       ; %bb.0:
; GFX1250-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
...
; GFX1250-GISEL-NEXT:    ; return to shader part epilog
;
; GFX13-SDAG-LABEL: v_add_neg_f64:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_mov_b64 s[0:1], 0x4069033333333333
; GFX13-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-SDAG-NEXT:    v_add_f64_e64 v[0:1], -v[0:1], s[0:1]
; GFX13-SDAG-NEXT:    ; return to shader part epilog
;
; GFX13-GISEL-LABEL: v_add_neg_f64:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    v_max_num_f64_e32 v[0:1], v[0:1], v[0:1]
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v2, 0x33333333
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v3, 0x40690333
; GFX13-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-GISEL-NEXT:    v_add_f64_e64 v[0:1], -v[0:1], v[2:3]
; GFX13-GISEL-NEXT:    ; return to shader part epilog
...
; GFX1250-SDAG-NEXT:    v_mov_b32_e32 v1, 0x40632000
; GFX1250-SDAG-NEXT:    v_cndmask_b32_e64 v0, 0x33333333, 0, vcc_lo
; GFX1250-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1250-SDAG-NEXT:    v_cndmask_b32_e32 v1, 0x40690333, v1, vcc_lo
; GFX1250-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1250-GISEL-LABEL: v_cndmask:
; GFX1250-GISEL:       ; %bb.0:
; GFX1250-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-GISEL-NEXT:    v_cmp_eq_f64_e32 vcc_lo, 0, v[0:1]
; GFX1250-GISEL-NEXT:    v_mov_b32_e32 v1, 0x40690333
; GFX1250-GISEL-NEXT:    v_cndmask_b32_e64 v0, 0x33333333, 0, vcc_lo
; GFX1250-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1250-GISEL-NEXT:    v_cndmask_b32_e64 v1, v1, 0x40632000, vcc_lo
; GFX1250-GISEL-NEXT:    ; return to shader part epilog
;
; GFX13-SDAG-LABEL: v_cndmask:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    v_cmp_eq_f64_e32 vcc_lo, 0, v[0:1]
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v1, 0x40632000
; GFX13-SDAG-NEXT:    v_cndmask_b32_e64 v0, 0x33333333, 0, vcc_lo
; GFX13-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX13-SDAG-NEXT:    v_cndmask_b32_e32 v1, 0x40690333, v1, vcc_lo
; GFX13-SDAG-NEXT:    ; return to shader part epilog
;
; GFX13-GISEL-LABEL: v_cndmask:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    v_cmp_eq_f64_e32 vcc_lo, 0, v[0:1]
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v1, 0x40690333
; GFX13-GISEL-NEXT:    v_cndmask_b32_e64 v0, 0x33333333, 0, vcc_lo
; GFX13-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX13-GISEL-NEXT:    v_cndmask_b32_e64 v1, v1, 0x40632000, vcc_lo
; GFX13-GISEL-NEXT:    ; return to shader part epilog
