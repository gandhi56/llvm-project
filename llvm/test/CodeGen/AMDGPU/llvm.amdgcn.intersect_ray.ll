...
; RUN: llc -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1013 < %s | FileCheck -check-prefixes=PRE-GFX12,GFX10,GFX10-GISEL,GFX1013-GISEL %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1030 < %s | FileCheck -check-prefixes=PRE-GFX12,GFX10,GFX10-SDAG,GFX1030-SDAG %s
; RUN: llc -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1030 < %s | FileCheck -check-prefixes=PRE-GFX12,GFX10,GFX10-GISEL,GFX1030-GISEL %s
...
; RUN: llc -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 < %s | FileCheck -check-prefixes=PRE-GFX12,GFX11-GISEL %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 < %s | FileCheck -check-prefixes=PRE-GFX12,GFX11-SDAG %s
; RUN: llc -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 < %s | FileCheck -check-prefixes=PRE-GFX12,GFX11-GISEL %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1200 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX12,GFX12-SDAG %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1200 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX12,GFX12-SDAG %s
; RUN: llc -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1200 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX12,GFX12-GISEL %s
; RUN: llc -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1200 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX12,GFX12-GISEL %s
...
define amdgpu_ps <4 x float> @image_bvh_intersect_ray_ssssss(i32 inreg %node_ptr, float inreg %ray_extent, <3 x float> inreg %ray_origin, <3 x float> inreg %ray_dir, <3 x float> inreg %ray_inv_dir, <4 x i32> inreg %tdescr) {
; GFX10-SDAG-LABEL: image_bvh_intersect_ray_ssssss:
; GFX10-SDAG:       ; %bb.0:
...
; GFX10-SDAG-NEXT:    v_mov_b32_e32 v9, s9
; GFX10-SDAG-NEXT:    v_mov_b32_e32 v10, s10
; GFX10-SDAG-NEXT:    s_mov_b32 s15, s14
; GFX10-SDAG-NEXT:    s_mov_b32 s14, s13
; GFX10-SDAG-NEXT:    s_mov_b32 s13, s12
; GFX10-SDAG-NEXT:    s_mov_b32 s12, s11
; GFX10-SDAG-NEXT:    image_bvh_intersect_ray v[0:3], v[0:10], s[12:15]
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX10-SDAG-NEXT:    ; return to shader part epilog
;
; GFX10-GISEL-LABEL: image_bvh_intersect_ray_ssssss:
; GFX10-GISEL:       ; %bb.0:
...
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v9, s9
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v10, s10
; GFX10-GISEL-NEXT:    s_mov_b32 s16, s11
; GFX10-GISEL-NEXT:    s_mov_b32 s17, s12
; GFX10-GISEL-NEXT:    s_mov_b32 s18, s13
; GFX10-GISEL-NEXT:    s_mov_b32 s19, s14
; GFX10-GISEL-NEXT:    image_bvh_intersect_ray v[0:3], v[0:10], s[16:19]
; GFX10-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-GISEL-NEXT:    ; return to shader part epilog
;
; GFX11-SDAG-LABEL: image_bvh_intersect_ray_ssssss:
; GFX11-SDAG:       ; %bb.0:
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v0, s8 :: v_dual_mov_b32 v1, s9
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v2, s10 :: v_dual_mov_b32 v3, s5
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v4, s6 :: v_dual_mov_b32 v5, s7
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v6, s2 :: v_dual_mov_b32 v7, s3
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v8, s4 :: v_dual_mov_b32 v9, s0
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v10, s1
; GFX11-SDAG-NEXT:    s_mov_b32 s15, s14
; GFX11-SDAG-NEXT:    s_mov_b32 s14, s13
; GFX11-SDAG-NEXT:    s_mov_b32 s13, s12
; GFX11-SDAG-NEXT:    s_mov_b32 s12, s11
; GFX11-SDAG-NEXT:    image_bvh_intersect_ray v[0:3], [v9, v10, v[6:8], v[3:5], v[0:2]], s[12:15]
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-NEXT:    ; return to shader part epilog
;
; GFX11-GISEL-LABEL: image_bvh_intersect_ray_ssssss:
; GFX11-GISEL:       ; %bb.0:
; GFX11-GISEL-NEXT:    s_mov_b32 s16, s2
; GFX11-GISEL-NEXT:    s_mov_b32 s18, s4
; GFX11-GISEL-NEXT:    s_mov_b32 s20, s5
; GFX11-GISEL-NEXT:    s_mov_b32 s17, s3
...
; GFX11-GISEL-NEXT:    s_mov_b32 s7, s14
; GFX11-GISEL-NEXT:    image_bvh_intersect_ray v[0:3], [v9, v10, v[0:2], v[3:5], v[6:8]], s[4:7]
; GFX11-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX11-GISEL-NEXT:    ; return to shader part epilog
;
; GFX12-SDAG-LABEL: image_bvh_intersect_ray_ssssss:
; GFX12-SDAG:       ; %bb.0:
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v0, s8 :: v_dual_mov_b32 v1, s9
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v2, s10 :: v_dual_mov_b32 v3, s5
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v4, s6 :: v_dual_mov_b32 v5, s7
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v6, s2 :: v_dual_mov_b32 v7, s3
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v8, s4 :: v_dual_mov_b32 v9, s0
; GFX12-SDAG-NEXT:    v_mov_b32_e32 v10, s1
...
; GFX12-SDAG-NEXT:    image_bvh_intersect_ray v[0:3], [v9, v10, v[6:8], v[3:5], v[0:2]], s[12:15]
; GFX12-SDAG-NEXT:    s_wait_bvhcnt 0x0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
; GFX12-GISEL-LABEL: image_bvh_intersect_ray_ssssss:
; GFX12-GISEL:       ; %bb.0:
; GFX12-GISEL-NEXT:    s_mov_b32 s16, s2
; GFX12-GISEL-NEXT:    s_mov_b32 s17, s3
; GFX12-GISEL-NEXT:    s_mov_b32 s18, s4
...
; GFX11-GISEL-NEXT:    s_mov_b32 s20, s2
; GFX11-GISEL-NEXT:    s_mov_b32 s22, s4
; GFX11-GISEL-NEXT:    s_pack_ll_b32_b16 s4, s7, s5
; GFX11-GISEL-NEXT:    s_mov_b32 s21, s3
; GFX11-GISEL-NEXT:    s_pack_hh_b32_b16 s5, s7, s5
; GFX11-GISEL-NEXT:    s_pack_ll_b32_b16 s6, s8, s6
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v0, s20 :: v_dual_mov_b32 v1, s21
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v2, s22 :: v_dual_mov_b32 v3, s4
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v6, s0 :: v_dual_mov_b32 v7, s1
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v4, s5 :: v_dual_mov_b32 v5, s6
; GFX11-GISEL-NEXT:    s_mov_b32 s16, s9
; GFX11-GISEL-NEXT:    s_mov_b32 s17, s10
; GFX11-GISEL-NEXT:    s_mov_b32 s18, s11
; GFX11-GISEL-NEXT:    s_mov_b32 s19, s12
; GFX11-GISEL-NEXT:    image_bvh_intersect_ray v[0:3], [v6, v7, v[0:2], v[3:5]], s[16:19] a16
; GFX11-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX11-GISEL-NEXT:    ; return to shader part epilog
;
...
define amdgpu_ps <4 x float> @image_bvh64_intersect_ray_ssssss(i64 inreg %node_ptr, float inreg %ray_extent, <3 x float> inreg %ray_origin, <3 x float> inreg %ray_dir, <3 x float> inreg %ray_inv_dir, <4 x i32> inreg %tdescr) {
; GFX10-LABEL: image_bvh64_intersect_ray_ssssss:
; GFX10:       ; %bb.0:
...
; GFX10-NEXT:    image_bvh64_intersect_ray v[0:3], v[0:11], s[12:15]
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-SDAG-LABEL: image_bvh64_intersect_ray_ssssss:
; GFX11-SDAG:       ; %bb.0:
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v0, s9 :: v_dual_mov_b32 v1, s10
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v2, s11 :: v_dual_mov_b32 v3, s6
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v4, s7 :: v_dual_mov_b32 v5, s8
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v6, s3 :: v_dual_mov_b32 v7, s4
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v8, s5 :: v_dual_mov_b32 v9, s0
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v10, s1 :: v_dual_mov_b32 v11, s2
; GFX11-SDAG-NEXT:    image_bvh64_intersect_ray v[0:3], [v[9:10], v11, v[6:8], v[3:5], v[0:2]], s[12:15]
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-NEXT:    ; return to shader part epilog
;
; GFX11-GISEL-LABEL: image_bvh64_intersect_ray_ssssss:
; GFX11-GISEL:       ; %bb.0:
; GFX11-GISEL-NEXT:    s_mov_b32 s17, s4
; GFX11-GISEL-NEXT:    s_mov_b32 s4, s6
; GFX11-GISEL-NEXT:    s_mov_b32 s16, s3
; GFX11-GISEL-NEXT:    s_mov_b32 s6, s8
; GFX11-GISEL-NEXT:    s_mov_b32 s8, s9
; GFX11-GISEL-NEXT:    s_mov_b32 s18, s5
; GFX11-GISEL-NEXT:    s_mov_b32 s5, s7
...
; GFX11-GISEL-NEXT:    ; return to shader part epilog
;
; GFX12-SDAG-LABEL: image_bvh64_intersect_ray_ssssss:
; GFX12-SDAG:       ; %bb.0:
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v0, s9 :: v_dual_mov_b32 v1, s10
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v2, s11 :: v_dual_mov_b32 v3, s6
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v4, s7 :: v_dual_mov_b32 v5, s8
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v6, s3 :: v_dual_mov_b32 v7, s4
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v8, s5 :: v_dual_mov_b32 v9, s0
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v10, s1 :: v_dual_mov_b32 v11, s2
; GFX12-SDAG-NEXT:    image_bvh64_intersect_ray v[0:3], [v[9:10], v11, v[6:8], v[3:5], v[0:2]], s[12:15]
; GFX12-SDAG-NEXT:    s_wait_bvhcnt 0x0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
; GFX12-GISEL-LABEL: image_bvh64_intersect_ray_ssssss:
; GFX12-GISEL:       ; %bb.0:
...
; GFX11-GISEL:       ; %bb.0: ; %main_body
; GFX11-GISEL-NEXT:    s_mov_b32 s20, s3
; GFX11-GISEL-NEXT:    s_mov_b32 s21, s4
; GFX11-GISEL-NEXT:    s_pack_ll_b32_b16 s4, s8, s6
; GFX11-GISEL-NEXT:    s_mov_b32 s22, s5
; GFX11-GISEL-NEXT:    s_pack_hh_b32_b16 s5, s8, s6
; GFX11-GISEL-NEXT:    s_pack_ll_b32_b16 s6, s9, s7
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v0, s20 :: v_dual_mov_b32 v3, s4
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v7, s1 :: v_dual_mov_b32 v6, s0
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v8, s2 :: v_dual_mov_b32 v1, s21
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v2, s22 :: v_dual_mov_b32 v5, s6
; GFX11-GISEL-NEXT:    v_mov_b32_e32 v4, s5
; GFX11-GISEL-NEXT:    s_mov_b32 s16, s10
; GFX11-GISEL-NEXT:    s_mov_b32 s17, s11
; GFX11-GISEL-NEXT:    s_mov_b32 s18, s12
; GFX11-GISEL-NEXT:    s_mov_b32 s19, s13
; GFX11-GISEL-NEXT:    image_bvh64_intersect_ray v[0:3], [v[6:7], v8, v[0:2], v[3:5]], s[16:19] a16
; GFX11-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX11-GISEL-NEXT:    ; return to shader part epilog
;
...
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v0, s20
...
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v3, s4
...
; GFX1013-SDAG-LABEL: image_bvh_intersect_ray_nsa_reassign:
; GFX1013-SDAG:       ; %bb.0: ; %main_body
; GFX1013-SDAG-NEXT:    s_load_dwordx8 s[8:15], s[4:5], 0x24
; GFX1013-SDAG-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v10, 0x41000000
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v9, 0x40e00000
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v8, 0x40c00000
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v7, 0x40a00000
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v6, 4.0
; GFX1013-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1013-SDAG-NEXT:    v_add_co_u32 v2, s0, s8, v0
; GFX1013-SDAG-NEXT:    v_add_co_ci_u32_e64 v3, s0, s9, 0, s0
; GFX1013-SDAG-NEXT:    v_add_co_u32 v4, s0, s10, v0
; GFX1013-SDAG-NEXT:    v_add_co_ci_u32_e64 v5, s0, s11, 0, s0
; GFX1013-SDAG-NEXT:    flat_load_dword v0, v[2:3]
; GFX1013-SDAG-NEXT:    flat_load_dword v1, v[4:5]
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v2, 0
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v5, 0x40400000
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v4, 2.0
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v3, 1.0
; GFX1013-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1013-SDAG-NEXT:    image_bvh_intersect_ray v[0:3], v[0:10], s[12:15]
; GFX1013-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX1013-SDAG-NEXT:    flat_store_dwordx4 v[0:1], v[0:3]
; GFX1013-SDAG-NEXT:    s_endpgm
;
; GFX1013-GISEL-LABEL: image_bvh_intersect_ray_nsa_reassign:
; GFX1013-GISEL:       ; %bb.0: ; %main_body
; GFX1013-GISEL-NEXT:    s_load_dwordx8 s[8:15], s[4:5], 0x24
; GFX1013-GISEL-NEXT:    v_lshlrev_b32_e32 v6, 2, v0
; GFX1013-GISEL-NEXT:    v_mov_b32_e32 v7, 0x40a00000
; GFX1013-GISEL-NEXT:    v_mov_b32_e32 v8, 0x40c00000
; GFX1013-GISEL-NEXT:    v_mov_b32_e32 v9, 0x40e00000
; GFX1013-GISEL-NEXT:    v_mov_b32_e32 v10, 0x41000000
...
; GFX1013-GISEL-NEXT:    v_mov_b32_e32 v6, 4.0
...
; GFX1013-GISEL-NEXT:    v_mov_b32_e32 v5, 0x40400000
; GFX1013-GISEL-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1013-GISEL-NEXT:    image_bvh_intersect_ray v[0:3], v[0:10], s[12:15]
; GFX1013-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX1013-GISEL-NEXT:    flat_store_dwordx4 v[0:1], v[0:3]
; GFX1013-GISEL-NEXT:    s_endpgm
;
; GFX1030-SDAG-LABEL: image_bvh_intersect_ray_nsa_reassign:
; GFX1030-SDAG:       ; %bb.0: ; %main_body
; GFX1030-SDAG-NEXT:    s_load_dwordx8 s[0:7], s[4:5], 0x24
; GFX1030-SDAG-NEXT:    v_lshlrev_b32_e32 v2, 2, v0
; GFX1030-SDAG-NEXT:    v_mov_b32_e32 v10, 0x41000000
; GFX1030-SDAG-NEXT:    v_mov_b32_e32 v9, 0x40e00000
...
; GFX1030-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX1030-SDAG-NEXT:    flat_store_dwordx4 v[0:1], v[0:3]
; GFX1030-SDAG-NEXT:    s_endpgm
;
; GFX1030-GISEL-LABEL: image_bvh_intersect_ray_nsa_reassign:
; GFX1030-GISEL:       ; %bb.0: ; %main_body
...
;
; GFX11-SDAG-LABEL: image_bvh_intersect_ray_nsa_reassign:
; GFX11-SDAG:       ; %bb.0: ; %main_body
; GFX11-SDAG-NEXT:    s_load_b256 s[0:7], s[4:5], 0x24
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v7, 1.0 :: v_dual_and_b32 v0, 0x3ff, v0
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v5, 0x40a00000 :: v_dual_mov_b32 v6, 0
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v8, 2.0
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_2)
...
; GFX11-SDAG-NEXT:    flat_load_b32 v9, v[0:1]
; GFX11-SDAG-NEXT:    flat_load_b32 v10, v[2:3]
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v0, 0x40c00000
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v1, 0x40e00000
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v2, 0x41000000
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v3, 0x40400000
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX11-SDAG-NEXT:    image_bvh_intersect_ray v[0:3], [v9, v10, v[6:8], v[3:5], v[0:2]], s[4:7]
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-NEXT:    flat_store_b128 v[0:1], v[0:3]
; GFX11-SDAG-NEXT:    s_endpgm
;
; GFX11-GISEL-LABEL: image_bvh_intersect_ray_nsa_reassign:
; GFX11-GISEL:       ; %bb.0: ; %main_body
; GFX11-GISEL-NEXT:    s_load_b256 s[0:7], s[4:5], 0x24
; GFX11-GISEL-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-GISEL-NEXT:    s_mov_b32 s10, 0x40a00000
; GFX11-GISEL-NEXT:    s_mov_b32 s9, 4.0
; GFX11-GISEL-NEXT:    s_mov_b32 s8, 0x40400000
; GFX11-GISEL-NEXT:    s_mov_b32 s12, 0x40c00000
; GFX11-GISEL-NEXT:    v_lshlrev_b32_e32 v4, 2, v0
; GFX11-GISEL-NEXT:    s_mov_b32 s14, 0x41000000
; GFX11-GISEL-NEXT:    s_mov_b32 s13, 0x40e00000
; GFX11-GISEL-NEXT:    v_mov_b32_e32 v6, s12
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v8, s14 :: v_dual_mov_b32 v7, s13
; GFX11-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v2, s2 :: v_dual_mov_b32 v3, s3
; GFX11-GISEL-NEXT:    s_mov_b32 s2, 2.0
...
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v3, s8
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v1, s1 :: v_dual_mov_b32 v2, s2
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v4, s9 :: v_dual_mov_b32 v5, s10
...
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v6, s12 :: v_dual_mov_b32 v7, s13
...
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v3, s8 :: v_dual_mov_b32 v0, s0
...
; GFX1013-SDAG-LABEL: image_bvh_intersect_ray_a16_nsa_reassign:
; GFX1013-SDAG:       ; %bb.0: ; %main_body
; GFX1013-SDAG-NEXT:    s_load_dwordx8 s[8:15], s[4:5], 0x24
; GFX1013-SDAG-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v7, 0x48004700
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v6, 0x46004500
; GFX1013-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1013-SDAG-NEXT:    v_add_co_u32 v2, s0, s8, v0
; GFX1013-SDAG-NEXT:    v_add_co_ci_u32_e64 v3, s0, s9, 0, s0
; GFX1013-SDAG-NEXT:    v_add_co_u32 v4, s0, s10, v0
...
; GFX1013-SDAG-NEXT:    flat_load_dword v1, v[4:5]
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v2, 0
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v5, 0x44004200
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v4, 2.0
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v3, 1.0
; GFX1013-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1013-SDAG-NEXT:    image_bvh_intersect_ray v[0:3], v[0:7], s[12:15] a16
; GFX1013-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX1013-SDAG-NEXT:    flat_store_dwordx4 v[0:1], v[0:3]
; GFX1013-SDAG-NEXT:    s_endpgm
;
...
; GFX1013-GISEL-NEXT:    s_endpgm
;
; GFX1030-SDAG-LABEL: image_bvh_intersect_ray_a16_nsa_reassign:
; GFX1030-SDAG:       ; %bb.0: ; %main_body
; GFX1030-SDAG-NEXT:    s_load_dwordx8 s[0:7], s[4:5], 0x24
; GFX1030-SDAG-NEXT:    v_lshlrev_b32_e32 v2, 2, v0
...
; GFX1030-GISEL-NEXT:    s_endpgm
;
; GFX11-SDAG-LABEL: image_bvh_intersect_ray_a16_nsa_reassign:
; GFX11-SDAG:       ; %bb.0: ; %main_body
; GFX11-SDAG-NEXT:    s_load_b256 s[0:7], s[4:5], 0x24
; GFX11-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v4, 1.0 :: v_dual_mov_b32 v5, 2.0
...
; GFX11-SDAG-NEXT:    v_add_co_u32 v2, s0, s2, v2
; GFX11-SDAG-NEXT:    v_add_co_ci_u32_e64 v3, null, s3, 0, s0
; GFX11-SDAG-NEXT:    flat_load_b32 v6, v[0:1]
; GFX11-SDAG-NEXT:    flat_load_b32 v7, v[2:3]
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v0, 0x46004200
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v1, 0x47004400
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v2, 0x48004500 :: v_dual_mov_b32 v3, 0
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX11-SDAG-NEXT:    image_bvh_intersect_ray v[0:3], [v6, v7, v[3:5], v[0:2]], s[4:7] a16
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-NEXT:    flat_store_b128 v[0:1], v[0:3]
; GFX11-SDAG-NEXT:    s_endpgm
;
...
; GFX11-GISEL-NEXT:    s_load_b256 s[0:7], s[4:5], 0x24
; GFX11-GISEL-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-GISEL-NEXT:    s_mov_b32 s8, 0x42004600
; GFX11-GISEL-NEXT:    s_mov_b32 s9, 0x44004700
; GFX11-GISEL-NEXT:    s_mov_b32 s10, 0x45004800
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-GISEL-NEXT:    v_lshlrev_b32_e32 v4, 2, v0
; GFX11-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v2, s2 :: v_dual_mov_b32 v3, s3
...
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v4, s9 :: v_dual_mov_b32 v5, s10
; GFX11-GISEL-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX11-GISEL-NEXT:    image_bvh_intersect_ray v[0:3], [v6, v7, v[0:2], v[3:5]], s[4:7] a16
; GFX11-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX11-GISEL-NEXT:    flat_store_b128 v[0:1], v[0:3]
; GFX11-GISEL-NEXT:    s_endpgm
;
...
; GFX1013-SDAG-LABEL: image_bvh64_intersect_ray_nsa_reassign:
; GFX1013-SDAG:       ; %bb.0: ; %main_body
; GFX1013-SDAG-NEXT:    s_clause 0x1
; GFX1013-SDAG-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x24
; GFX1013-SDAG-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x34
; GFX1013-SDAG-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v3, 0
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v11, 0x41000000
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v10, 0x40e00000
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v9, 0x40c00000
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v8, 0x40a00000
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v7, 4.0
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v6, 0x40400000
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v5, 2.0
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v4, 1.0
; GFX1013-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1013-SDAG-NEXT:    v_add_co_u32 v0, s4, s6, v0
; GFX1013-SDAG-NEXT:    v_add_co_ci_u32_e64 v1, s4, s7, 0, s4
; GFX1013-SDAG-NEXT:    flat_load_dword v2, v[0:1]
; GFX1013-SDAG-NEXT:    v_bfrev_b32_e32 v1, 4.0
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v0, 0xb36211c7
; GFX1013-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1013-SDAG-NEXT:    image_bvh64_intersect_ray v[0:3], v[0:11], s[0:3]
; GFX1013-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX1013-SDAG-NEXT:    flat_store_dwordx4 v[0:1], v[0:3]
; GFX1013-SDAG-NEXT:    s_endpgm
;
; GFX1013-GISEL-LABEL: image_bvh64_intersect_ray_nsa_reassign:
; GFX1013-GISEL:       ; %bb.0: ; %main_body
...
; GFX1013-GISEL-NEXT:    v_mov_b32_e32 v6, 0x40400000
; GFX1013-GISEL-NEXT:    v_mov_b32_e32 v7, 4.0
; GFX1013-GISEL-NEXT:    v_mov_b32_e32 v8, 0x40a00000
; GFX1013-GISEL-NEXT:    v_mov_b32_e32 v9, 0x40c00000
...
; GFX1013-GISEL-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1013-GISEL-NEXT:    image_bvh64_intersect_ray v[0:3], v[0:11], s[0:3]
; GFX1013-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX1013-GISEL-NEXT:    flat_store_dwordx4 v[0:1], v[0:3]
; GFX1013-GISEL-NEXT:    s_endpgm
;
; GFX1030-SDAG-LABEL: image_bvh64_intersect_ray_nsa_reassign:
; GFX1030-SDAG:       ; %bb.0: ; %main_body
; GFX1030-SDAG-NEXT:    s_clause 0x1
; GFX1030-SDAG-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x24
; GFX1030-SDAG-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x34
; GFX1030-SDAG-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX1030-SDAG-NEXT:    v_mov_b32_e32 v3, 0
; GFX1030-SDAG-NEXT:    v_mov_b32_e32 v11, 0x41000000
; GFX1030-SDAG-NEXT:    v_mov_b32_e32 v10, 0x40e00000
; GFX1030-SDAG-NEXT:    v_mov_b32_e32 v9, 0x40c00000
; GFX1030-SDAG-NEXT:    v_mov_b32_e32 v8, 0x40a00000
; GFX1030-SDAG-NEXT:    v_mov_b32_e32 v7, 4.0
; GFX1030-SDAG-NEXT:    v_mov_b32_e32 v6, 0x40400000
; GFX1030-SDAG-NEXT:    v_mov_b32_e32 v5, 2.0
; GFX1030-SDAG-NEXT:    v_mov_b32_e32 v4, 1.0
; GFX1030-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1030-SDAG-NEXT:    v_add_co_u32 v0, s4, s6, v0
; GFX1030-SDAG-NEXT:    v_add_co_ci_u32_e64 v1, null, s7, 0, s4
; GFX1030-SDAG-NEXT:    flat_load_dword v2, v[0:1]
; GFX1030-SDAG-NEXT:    v_bfrev_b32_e32 v1, 4.0
; GFX1030-SDAG-NEXT:    v_mov_b32_e32 v0, 0xb36211c7
; GFX1030-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1030-SDAG-NEXT:    image_bvh64_intersect_ray v[0:3], v[0:11], s[0:3]
; GFX1030-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX1030-SDAG-NEXT:    flat_store_dwordx4 v[0:1], v[0:3]
; GFX1030-SDAG-NEXT:    s_endpgm
;
; GFX1030-GISEL-LABEL: image_bvh64_intersect_ray_nsa_reassign:
; GFX1030-GISEL:       ; %bb.0: ; %main_body
...
; GFX1030-GISEL-NEXT:    v_mov_b32_e32 v6, 0x40400000
; GFX1030-GISEL-NEXT:    v_mov_b32_e32 v7, 4.0
; GFX1030-GISEL-NEXT:    v_mov_b32_e32 v8, 0x40a00000
; GFX1030-GISEL-NEXT:    v_mov_b32_e32 v9, 0x40c00000
...
; GFX1030-GISEL-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1030-GISEL-NEXT:    image_bvh64_intersect_ray v[0:3], v[0:11], s[0:3]
; GFX1030-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX1030-GISEL-NEXT:    flat_store_dwordx4 v[0:1], v[0:3]
; GFX1030-GISEL-NEXT:    s_endpgm
;
; GFX11-SDAG-LABEL: image_bvh64_intersect_ray_nsa_reassign:
; GFX11-SDAG:       ; %bb.0: ; %main_body
; GFX11-SDAG-NEXT:    s_clause 0x1
; GFX11-SDAG-NEXT:    s_load_b64 s[6:7], s[4:5], 0x24
; GFX11-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x34
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v7, 1.0 :: v_dual_and_b32 v0, 0x3ff, v0
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v2, 0x41000000
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v3, 0x40400000 :: v_dual_mov_b32 v4, 4.0
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v5, 0x40a00000 :: v_dual_lshlrev_b32 v0, 2, v0
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v6, 0
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v8, 2.0 :: v_dual_mov_b32 v9, 0xb36211c7
...
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v1, 0x40e00000
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX11-SDAG-NEXT:    image_bvh64_intersect_ray v[0:3], [v[9:10], v11, v[6:8], v[3:5], v[0:2]], s[0:3]
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-NEXT:    flat_store_b128 v[0:1], v[0:3]
; GFX11-SDAG-NEXT:    s_endpgm
;
; GFX11-GISEL-LABEL: image_bvh64_intersect_ray_nsa_reassign:
; GFX11-GISEL:       ; %bb.0: ; %main_body
; GFX11-GISEL-NEXT:    s_clause 0x1
; GFX11-GISEL-NEXT:    s_load_b64 s[6:7], s[4:5], 0x24
; GFX11-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x34
; GFX11-GISEL-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-GISEL-NEXT:    s_mov_b32 s5, 1.0
...
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v8, s14 :: v_dual_mov_b32 v3, s8
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v4, s9 :: v_dual_mov_b32 v7, s13
; GFX11-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v5, s10 :: v_dual_mov_b32 v0, s6
; GFX11-GISEL-NEXT:    v_mov_b32_e32 v1, s7
...
; GFX11-GISEL-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX11-GISEL-NEXT:    image_bvh64_intersect_ray v[0:3], [v[9:10], v11, v[0:2], v[3:5], v[6:8]], s[0:3]
; GFX11-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX11-GISEL-NEXT:    flat_store_b128 v[0:1], v[0:3]
; GFX11-GISEL-NEXT:    s_endpgm
;
...
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v7, s13 :: v_dual_mov_b32 v8, s14
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
...
; GFX1013-SDAG-LABEL: image_bvh64_intersect_ray_a16_nsa_reassign:
; GFX1013-SDAG:       ; %bb.0: ; %main_body
; GFX1013-SDAG-NEXT:    s_clause 0x1
; GFX1013-SDAG-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x24
; GFX1013-SDAG-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x34
; GFX1013-SDAG-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v3, 0
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v8, 0x48004700
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v7, 0x46004500
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v6, 0x44004200
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v5, 2.0
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v4, 1.0
; GFX1013-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1013-SDAG-NEXT:    v_add_co_u32 v0, s4, s6, v0
...
; GFX1013-SDAG-NEXT:    flat_load_dword v2, v[0:1]
; GFX1013-SDAG-NEXT:    v_bfrev_b32_e32 v1, 4.0
; GFX1013-SDAG-NEXT:    v_mov_b32_e32 v0, 0xb36211c6
; GFX1013-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1013-SDAG-NEXT:    image_bvh64_intersect_ray v[0:3], v[0:8], s[0:3] a16
; GFX1013-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX1013-SDAG-NEXT:    flat_store_dwordx4 v[0:1], v[0:3]
; GFX1013-SDAG-NEXT:    s_endpgm
;
; GFX1013-GISEL-LABEL: image_bvh64_intersect_ray_a16_nsa_reassign:
; GFX1013-GISEL:       ; %bb.0: ; %main_body
; GFX1013-GISEL-NEXT:    s_clause 0x1
; GFX1013-GISEL-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x24
; GFX1013-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x34
...
; GFX1013-GISEL-NEXT:    s_endpgm
;
; GFX1030-SDAG-LABEL: image_bvh64_intersect_ray_a16_nsa_reassign:
; GFX1030-SDAG:       ; %bb.0: ; %main_body
; GFX1030-SDAG-NEXT:    s_clause 0x1
; GFX1030-SDAG-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x24
; GFX1030-SDAG-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x34
; GFX1030-SDAG-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX1030-SDAG-NEXT:    v_mov_b32_e32 v3, 0
; GFX1030-SDAG-NEXT:    v_mov_b32_e32 v8, 0x48004700
; GFX1030-SDAG-NEXT:    v_mov_b32_e32 v7, 0x46004500
; GFX1030-SDAG-NEXT:    v_mov_b32_e32 v6, 0x44004200
; GFX1030-SDAG-NEXT:    v_mov_b32_e32 v5, 2.0
; GFX1030-SDAG-NEXT:    v_mov_b32_e32 v4, 1.0
; GFX1030-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1030-SDAG-NEXT:    v_add_co_u32 v0, s4, s6, v0
...
; GFX1030-SDAG-NEXT:    flat_load_dword v2, v[0:1]
; GFX1030-SDAG-NEXT:    v_bfrev_b32_e32 v1, 4.0
; GFX1030-SDAG-NEXT:    v_mov_b32_e32 v0, 0xb36211c6
; GFX1030-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1030-SDAG-NEXT:    image_bvh64_intersect_ray v[0:3], v[0:8], s[0:3] a16
; GFX1030-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX1030-SDAG-NEXT:    flat_store_dwordx4 v[0:1], v[0:3]
; GFX1030-SDAG-NEXT:    s_endpgm
;
; GFX1030-GISEL-LABEL: image_bvh64_intersect_ray_a16_nsa_reassign:
; GFX1030-GISEL:       ; %bb.0: ; %main_body
; GFX1030-GISEL-NEXT:    s_clause 0x1
; GFX1030-GISEL-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x24
; GFX1030-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x34
...
; GFX1030-GISEL-NEXT:    s_endpgm
;
; GFX11-SDAG-LABEL: image_bvh64_intersect_ray_a16_nsa_reassign:
; GFX11-SDAG:       ; %bb.0: ; %main_body
; GFX11-SDAG-NEXT:    s_clause 0x1
; GFX11-SDAG-NEXT:    s_load_b64 s[6:7], s[4:5], 0x24
; GFX11-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x34
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v3, 0 :: v_dual_and_b32 v0, 0x3ff, v0
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v2, 0x48004500
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v4, 1.0
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v6, 0xb36211c6
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_3)
; GFX11-SDAG-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX11-SDAG-NEXT:    v_bfrev_b32_e32 v7, 4.0
...
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v1, 0x47004400
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX11-SDAG-NEXT:    image_bvh64_intersect_ray v[0:3], [v[6:7], v8, v[3:5], v[0:2]], s[0:3] a16
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-NEXT:    flat_store_b128 v[0:1], v[0:3]
; GFX11-SDAG-NEXT:    s_endpgm
;
...
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v3, s8 :: v_dual_mov_b32 v4, s9
; GFX11-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v5, s10 :: v_dual_mov_b32 v0, s6
; GFX11-GISEL-NEXT:    v_mov_b32_e32 v1, s7
; GFX11-GISEL-NEXT:    s_mov_b32 s6, 2.0
...
; GFX11-GISEL-NEXT:    v_mov_b32_e32 v2, s6
; GFX11-GISEL-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX11-GISEL-NEXT:    image_bvh64_intersect_ray v[0:3], [v[6:7], v8, v[0:2], v[3:5]], s[0:3] a16
; GFX11-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX11-GISEL-NEXT:    flat_store_b128 v[0:1], v[0:3]
; GFX11-GISEL-NEXT:    s_endpgm
;
