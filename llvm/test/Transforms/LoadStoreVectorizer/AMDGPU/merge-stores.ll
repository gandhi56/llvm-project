...
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:    store <4 x i64> <i64 1234, i64 123, i64 456, i64 333>, ptr addrspace(1) [[OUT]], align 8
; CHECK-NEXT:    ret void
;
  %out.gep.1 = getelementptr i64, ptr addrspace(1) %out, i64 1
...
; CHECK-SAME: ptr addrspace(3) [[OUT:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:    store <4 x i32> <i32 1234, i32 123, i32 456, i32 333>, ptr addrspace(3) [[OUT]], align 4
; CHECK-NEXT:    ret void
;
  %out.gep.1 = getelementptr i32, ptr addrspace(3) %out, i32 1
...
; CHECK-NEXT:    store <6 x i32> <i32 13, i32 15, i32 62, i32 63, i32 11, i32 123>, ptr addrspace(1) [[OUT]], align 4
; CHECK-NEXT:    ret void
;
...
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    store <7 x i32> <i32 34, i32 999, i32 65, i32 33, i32 98, i32 91, i32 212>, ptr addrspace(1) [[OUT]], align 4
; CHECK-NEXT:    ret void
;
...
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:    store <8 x i32> <i32 34, i32 999, i32 65, i32 33, i32 98, i32 91, i32 212, i32 999>, ptr addrspace(1) [[OUT]], align 4
; CHECK-NEXT:    ret void
;
  store i32 34, ptr addrspace(1) %out, align 4
  %idx1 = getelementptr inbounds i32, ptr addrspace(1) %out, i64 1
